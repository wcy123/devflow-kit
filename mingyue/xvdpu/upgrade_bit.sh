...
(cd $tmpdir; tar -czf - mnt/sd-mmcblk0p1/BOOT.BIN usr/lib/dpu.xclbin hw.md5 |
 ssh -J xcdl190074,xbjjmphost01,xbjlabdpsvr16 root@10.176.179.54 /bin/tar -zvxf - -C /)
ssh -J xcdl190074,xbjjmphost01,xbjlabdpsvr16 root@10.176.179.54 "cd /&&cat hw.md5 && md5sum -c hw.md5 && sync&&sync&&sync&& /sbin/reboot"
