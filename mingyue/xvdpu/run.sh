...
#env XLNX_ENABLE_FINGERPRINT_CHECK=$check_fingerprint XLNX_ENABLE_DUMP=1 ./test_dpu_runner yolov3/yolov3_voc/yolov3_voc.xmodel yolov3_voc_0 yolov3/yolov3_voc/dump_gpu/data.bin 1 1 2>dump_yolov3_voc.log
...
#test jpeg
cd ~/classification
env XLNX_ENABLE_FINGERPRINT_CHECK=$check_fingerprint /usr/share/vitis_ai_library/samples/classification/test_jpeg_classification xvdpu_1.5_resnet_v1_50_prefetch sample_classification.jpg
...
cd ~/yolov3
env XLNX_ENABLE_FINGERPRINT_CHECK=$check_fingerprint /usr/share/vitis_ai_library/samples/yolov3/test_jpeg_yolov3 yolov3_voc_tf
