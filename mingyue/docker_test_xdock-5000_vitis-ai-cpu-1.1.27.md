...
cd $HOME
rm docker_test_0308
ln -s /proj/xcohdstaff5/$USER/nobkup/docker_test_0308/vitis-ai-docker docker_test_0308
```
### Preparing xclbin & models & samples
```
cd $HOME/docker_test_0308
cp -r /tmp/docker_test/vitis-ai-docker/mingyue ./
cd mingyue
ls
...
ls
docker images
./docker_run.sh xdock.xilinx.com/vitis-ai-cpu:1.1.27
```
