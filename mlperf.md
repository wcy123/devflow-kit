...
ssh xsjjump03
ssh demo@xsjfislx40
# cold reboot http://172.19.73.114
# load pdi
pdi
# /lib/firmware/xilinx/34643f782cf0df01a1dc3a18fd5a529f/partition.pdi
xsdb
source /home/demo/xsdb_jtag_boot.tcl
device program /lib/firmware/xilinx/34643f782cf0df01a1dc3a18fd5a529f/partition.pdi
reboot

# xclbin : /home/demo/satyapr/08_16_PDI_Drop/v4e_8pe_333MHz_xilinx_vck5000-es1_gen3x16_1_202010_1_25b6fcf_Aug15Sat1517.xclbin
# xmodel : /tmp/cas_resnet_v1_50_finetune_DPUCVDX8H_PROTOTYPE_0_dpu.xmodel
...
env  ASYNC=1 DEBUG_ASYNC_RUNNER=0 XLNX_MAX_WAITING_TIME_IN_MS=20 XLNX_ASYNC_RUNNER_PERF=0 NUM_OF_RUNNERS=4 DEBUG_XRT_DEVICE_HANDLE=0 DEBUG_DPU_RUNNER=0 XLNX_ENABLE_FINGERPRINT_CHECK=0 XLNX_SHOW_DPU_COUNTER=0 ~/build/build.CentOS.7.6.1810.x86_64.Release/my_vart/dpu-runner/test/test_dpu_runner_mt resnet50_new_v4e_acc/resnet50_new_v4e_acc.xmodel subgraph_fake_downsample_0_ReplaceConv2d 32

# 3834 FPS

```

# test performance use mlperf
```

cd /home/demo/mingyue/mlperf-vitis-benchmark-app
make
export LD_LIBRARY_PATH=/home/demo/.local/CentOS.7.6.1810.x86_64.Release/lib:/usr/local/lib:/usr/local/lib64:/opt/xilinx/xrt/lib:/home/demo/aaronn/mlperf-inference/loadgen/build
env XLNX_MAX_WAITING_TIME_IN_MS=1 XLNX_ENABLE_FINGERPRINT_CHECK=0 DEBUG_ASYNC_RUNNER=0 XLNX_ASYNC_RUNNER_PERF=0 ./app.exe -d resnet50_new_v4e_acc/resnet50_new_v4e_acc.xmodel -i /home/demo/CK-TOOLS/dataset-imagenet-ilsvrc2012-val-min --mode PerformanceOnly --scenario Server --num_samples 80 -a 200 -r 3790;cat mlperf_log_summary.txt | grep 'Complete\|Scheduled'
...
# test acc use mlperf
```
./run.sh --exe app --mode AccuracyOnly --scenario  SingleStream -n 5000
#acc   76.620%

## segmentation when -n > 5399
